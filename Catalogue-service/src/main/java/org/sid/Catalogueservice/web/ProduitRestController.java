...
public class ProduitRestController {
    ...
    @GetMapping("/produitsWithQuantiteLessThan")
    public Page<Produit> getProduitsWithQuantiteLessThan(
            @RequestParam(defaultValue = "0") int page,
            @RequestParam(defaultValue = "4") int size,
            @RequestParam(defaultValue = "") String keyword) {

        return produitService.getProduitsWithQuantiteLessThan40(PageRequest.of(page, size), keyword);
    }
